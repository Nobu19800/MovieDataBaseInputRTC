...
moviedatabase_spec = ["implementation_id", "MovieDataBase", 
		 "type_name",         "MovieDataBase", 
...
# 
# 
class MovieDataBase(OpenRTM_aist.DataFlowComponentBase):
...
def MovieDataBaseInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=moviedatabase_spec)
    manager.registerFactory(profile,
                            MovieDataBase,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    MovieDataBaseInit(manager)

    # Create a component
    comp = manager.createComponent("MovieDataBase")
